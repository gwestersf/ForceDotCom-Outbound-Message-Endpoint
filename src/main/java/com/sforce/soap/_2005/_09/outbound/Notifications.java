 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}gwestr__Shipment__cNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<GwestrShipmentCNotification> notification;
     ...
     * {@link GwestrShipmentCNotification }
     * 
     * 
     */
    public List<GwestrShipmentCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<GwestrShipmentCNotification>();
        }
